...
(function ($) {
    ...
    $.Popup.prototype = {
        init : function() {
            ...
            this.el.boxSrc = this.el.attr('id');
        ...
        displayImage : function() {
            ...
            if (this.opts.gallery === true) {
                ...
                if (this.el.galleryTitle !== false) {
                    contentBox.append('<div class="galleryControls"><a href="" class="prev">назад</a><a href="" class="next">вперед</a></div>');
                    ...
                    if (this.opts.galleryCounter === true) {
                        ...
                        contentBox.find(".galleryControls").append("<p class='galleryCounter'>" + thisIndex + " из " + galleryLength + "</p>");
                    }
                }
        ...
        openBox : function() {
            ...
            if (this.el.attr("name")) {
                this.el.imageDesc = $(this.el).attr("name");
            }
            else {
                this.el.imageDesc = $(this.el).attr("alt");
            }
